(function () {
  ...
  function buildWidgetHtml() {
    return (
      '<div class="ecari-elf-root" id="ecari-elf-root" aria-live="polite">' +
  ...
  function shouldMount() {
    return !!document.querySelector('.layout-wrapper.layout-content-navbar');
  }
  ...
  if (document.querySelector('.layout-wrapper.layout-content-navbar')) init();
})();
