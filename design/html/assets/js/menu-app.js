(function () {
  ...
  var MODULE_ITEMS = [
    ...
    },
    {
      ...
      icon: 'ti-packages',
      children: [
        { id: 'stok-liste', label: 'Stok Listesi', href: 'stok-liste.html' }
      ]
    },
    {
      id: 'hizli-satis',
    ...
    },
    {
      ...
      icon: 'ti-checklist',
      children: [
        { id: 'gorev-liste', label: 'Görev Listesi', href: 'gorev-liste.html' }
      ]
    },
    {
      id: 'masraf',
      ...
      icon: 'ti-receipt-2',
      children: [
        { id: 'masraf-liste', label: 'Masraf Listesi', href: 'masraf-liste.html' },
        { id: 'masraf-yonetimi', label: 'Masraf Yönetimi', href: 'masraf-yonetimi.html' }
      ]
    },
    {
      id: 'kasa',
      ...
      icon: 'ti-cash',
      children: [
        { id: 'kasa-ana', label: 'Kasa', href: 'kasa.html' },
        { id: 'gun-sonu-raporu', label: 'Gün Sonu Raporu', href: 'gun-sonu-raporu.html' }
      ]
    },
    {
      id: 'banka',
